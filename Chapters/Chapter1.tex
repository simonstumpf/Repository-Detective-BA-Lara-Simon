...
Zusätzlich sollen die folgenden Hypothesen untersucht werden.\\
\textbf{Hypothese 1}:
Gegen Ende des Projekts werden Pull Requests schneller gemergt.

\textbf{Hypothese 2}:
Teilzeitstudierende verfügen über mehr Erfahrung in der Durchführung von Softwareprojekten und nutzen Pull Requests effizienter als Vollzeitstudierende.
