...
\section{GitGauge}
Wie in Kapitel \secref{sec:Ausgangslage} beschrieben, ist \textit{GitGauge} ein an der ZHAW entwickeltes Repository-Mining und Analysetool von GitHub-Repositories.
