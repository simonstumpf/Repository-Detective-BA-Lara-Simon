...
\begin{itemize}
    ...
    \item \textbf{Data Extractor (Miner)}: Die Data Extractor Services sind in C\# .NET Core geschrieben. In ihnen findet das Mining statt. Die Services erstellen die GraphQL-Abfragen und führen sie aus. Das Ergebnis der Abfragen wird anschliessend in die Datenbank geschrieben. 
