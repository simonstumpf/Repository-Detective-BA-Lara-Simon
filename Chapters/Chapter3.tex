...
In der Literatur wurden zahlreiche Metriken identifiziert, die im Zusammenhang mit Pull Requests untersucht wurden. Besonders häufig finden sich dabei Analysen zur \textit{latency} sowie zur Akzeptanz von Pull Requests. Diese sind in \autoref{Chapter2} aufgeführt. Auffällig war, dass Studien teils widersprüchliche Ergebnisse hinsichtlich eines möglichen Zusammenhangs zwischen \textit{latency} und \textit{churn} (Anzahl geänderter Codezeilen) aufzeigen. Auf Basis dieses Befunds wurde die \fref{forschungsfrage1} abgeleitet, um diesen Zusammenhang zu untersuchen.

In vielen Studien werden hauptsächlich Open-Source-Projekte untersucht. Diese unterscheiden sich jedoch, wie in Kapitel \secref{sec:Projektmodule} und \secref{sec:OpenSourceProjekte} erläutert, in wesentlichen Aspekten von studentischen Softwareprojekten – etwa hinsichtlich der Teamstruktur, Zielsetzung, Zeitplanung und des Erfahrungsniveaus der Beteiligten. Aus diesem Grund wurden zunächst die spezifischen Rahmenbedingungen von studentischen Projekten analysiert und darauf aufbauend relevante Metriken definiert.

Aus dieser Analyse ergaben sich die Forschungsfragen 3 bis 5, die sich mit dem Einfluss des Projektverlaufs, dem Arbeitsverhalten der Studierenden sowie Unterschieden zwischen Teilzeit- und Vollzeitstudierenden befassen. Zusätzlich wurde Forschungsfrage 2 formuliert, um zu untersuchen, ob sich die Schliessungsgründe von Pull Requests in studentischen Projekten identifizieren und klassifizieren lassen und ob sich die in der Literatur etablierten Metriken zur Akzeptanz auch auf diesen Kontext übertragen lassen. Um darüber hinaus die Unterschiede zwischen studentischen Projekten und professionellen Open-Source-Projekten systematisch zu untersuchen, wurde Forschungsfrage 6 formuliert.
