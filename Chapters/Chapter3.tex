...
Anhand des Buchstabens \textit{t} kann somit erkannt werden, ob eine Klasse Teilzeit oder Vollzeit ist.
...
Mit \textit{Git-Squashing} können mehrere Commits zu einem Commit zusammengeführt werden, bevor diese in den Zielbranch gemerged werden. Die theoretischen Grundlagen werden in \secref{sec:GitSquashing} erläutert. 
