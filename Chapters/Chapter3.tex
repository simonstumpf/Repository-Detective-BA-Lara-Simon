...
\label{sec:Metriken}
Um die Forschungsfragen beantworten zu können, musste das Mining erweitert werden. Dafür wurden weitere GraphQL-Abfragen implementiert und ein neuer  Miner für Repositories erstellt und den Miner für Pull Requests erweitert. Bei den Minern handelt es sich um sogenannte Extractor-Services, welche ...

Um die erste \fref{forschungsfrage1} beantworten zu können, müssen die Metriken \textit{Latency} und \textit{Churn} eingeführt werden. Die \textit{Latency} bestimmt die Zeit von wann der Pull Request geöffnet wurde bis zur Schliessung des Pull Requests, sei dies durch das Mergen des PRs oder durch manuelle Schliessung. Die \textit{Latency} wird anhand folgender Formel berechnet:
\begin{equation}
...
\begin{figure}[htbp]
    \centering
        \includegraphics[width=\textwidth]{Figures/GraphQL-Abfrage-additions-deletions.png}
    \caption{GraphQL-Abfrage additions und deletions}
    \label{fig:GraphQL-Abfrage-additions-deletions}
\end{figure}
...
\begin{figure}[htbp]
    \centering
        \includegraphics[width=\textwidth]{Figures/GraphQl-Abfrage-repo.png}
    \caption{GraphQL-Abfrage Repository}
    \label{fig:GraphQl-Abfrage-repo}
\end{figure}
...
\begin{figure}[htbp]
    \centering
        \includegraphics[width=\textwidth]{Figures/GraphQL-Abfrage-commits.png}
    \caption{GraphQL-Abfrage Pull Request Commits}
    \label{fig:GraphQl-Abfrage-commits}
\end{figure}
